...
public class Sun extends StaticEntity {
	...
	public Sun(Handler handler, float x, float y) {
	...
	public void render(Graphics2D g) {
		g.drawImage(Assets.sun,(int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
	}
