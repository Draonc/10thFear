...
import dev.Sandefur.fear.states.MazeState;
import dev.Sandefur.fear.states.State;

public class MazePortal extends Portal {
	private Animation portal;

	public MazePortal(Handler handler, float x, float y) {
		super(handler, x, y);
		portal = new Animation(100, Assets.lostPort);
	}
