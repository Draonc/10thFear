...
public class Ray extends StaticEntity {
	private int w = 0, h = 0;
	private Timer timer;
	
	public EntityManager entityManager = handler.getWorld().getEntityManager();
	
	public Ray(Handler handler, float x, float y, int w, int h) {
	...
	public void render(Graphics2D g) {
		g.drawImage(Assets.ray,(int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), Tile.TILEWIDTH * w, Tile.TILEHEIGHT * h, null);
