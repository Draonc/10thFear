...
public class TokenDrowning extends StaticEntity{
	...
	public void render(Graphics2D g) {
		g.drawImage(Assets.t1,(int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
	}
