...
public class TokenDeath extends StaticEntity{
	...
	public void render(Graphics2D g) {
		g.drawImage(Assets.t3,(int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
	}
