...
public class RedBlob extends Enemy {
	...
	public RedBlob(Handler handler, float x, float y) {
		...
		//Animatons
		animDown = new Animation(500, Assets.orangegoop_down);
		animUp = new Animation(500, Assets.orangegoop_up);
		animLeft = new Animation(500, Assets.orangegoop_left);
		animRight = new Animation(500, Assets.orangegoop_right);
	}
