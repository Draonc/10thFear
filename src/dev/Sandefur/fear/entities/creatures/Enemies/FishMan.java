...
public class FishMan extends PlatformerEnemy {

	//Animations
	private Animation animLeft, animRight;
		
	public FishMan(Handler handler, float x, float y) {
		...
		//Animatons
		animLeft = new Animation(500, Assets.waterman_left);
		animRight = new Animation(500, Assets.waterman_right);
	}
