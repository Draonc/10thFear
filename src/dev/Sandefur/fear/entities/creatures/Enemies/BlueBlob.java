...
public class BlueBlob extends PlatformerEnemy {

	//Animations
	private Animation animLeft, animRight;
		
	public BlueBlob(Handler handler, float x, float y) {
		...
		//Animatons
		animLeft = new Animation(500, Assets.bluegoop_left);
		animRight = new Animation(500, Assets.bluegoop_right);
	}
