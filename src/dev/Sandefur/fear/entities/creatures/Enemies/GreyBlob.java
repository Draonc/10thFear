...
public class GreyBlob extends PlatformerEnemy {

	//Animations
	private Animation animLeft, animRight;
		
	public GreyBlob(Handler handler, float x, float y) {
		...
		//Animatons
		animLeft = new Animation(300, Assets.greygoop_left);
		animRight = new Animation(300, Assets.greygoop_right);
	}
