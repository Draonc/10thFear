...
public class Shark extends Enemy {
	...
	public Shark(Handler handler, float x, float y) {
		...
		//Animatons
		animDown = new Animation(500, Assets.shark_down);
		animUp = new Animation(500, Assets.shark_up);
		animLeft = new Animation(500, Assets.shark_left);
		animRight = new Animation(500, Assets.shark_right);
	}
