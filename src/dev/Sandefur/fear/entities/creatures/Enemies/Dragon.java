...
public class Dragon extends Enemy {
	...
	public Dragon(Handler handler, float x, float y) {
		...
		//Animatons
		animDown = new Animation(500, Assets.dragon_down);
		animUp = new Animation(500, Assets.dragon_up);
		animLeft = new Animation(500, Assets.dragon_left);
		animRight = new Animation(500, Assets.dragon_right);
	}
