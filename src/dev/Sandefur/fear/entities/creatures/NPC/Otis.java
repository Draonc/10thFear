...
public class Otis extends NPC {
	...
	public Otis(Handler handler, float x, float y, int dia) {
		...
		//Animatons
		animDown = new Animation(500, Assets.Otis_down);
		animUp = new Animation(500, Assets.Otis_up);
		animLeft = new Animation(500, Assets.Otis_left);
		animRight = new Animation(500, Assets.Otis_right);
	}
