...
public class Alec extends NPC {

	//Animations
	private Animation animDown, animUp, animLeft, animRight;
	private int dia;
		
	public Alec(Handler handler, float x, float y, int dia) {
		...
		//Animatons
		animDown = new Animation(500, Assets.Alec_down);
		animUp = new Animation(500, Assets.Alec_up);
		animLeft = new Animation(500, Assets.Alec_left);
		animRight = new Animation(500, Assets.Alec_right);
	}
