...
public class Dog extends NPC {
	...
	public Dog(Handler handler, float x, float y) {
		...
		bounds.height = 37;
		//Animatons
		animDown = new Animation(300, Assets.dog_down);
		animUp = new Animation(300, Assets.dog_up);
		animLeft = new Animation(300, Assets.dog_left);
		animRight = new Animation(300, Assets.dog_right);
	}
